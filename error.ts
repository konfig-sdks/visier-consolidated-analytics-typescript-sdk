...
/**
 * This class provides a wrapper for network errors when making requests to Visier Consolidated Analytics APIs
 */
export class VisierConsolidatedAnalyticsError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "VisierConsolidatedAnalyticsError";
